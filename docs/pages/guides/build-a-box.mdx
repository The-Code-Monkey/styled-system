...
This guide will walk through creating a Multi purpose Box component and show you how you can add additional functionality using Styled System.
...
If you find yourself writing the same Box component over-and-over again, you might want to consider using a library like [@techstack/components][] or publishing your own UI component library to npm for reuse.
...
[@techstack/components]: https://www.npmjs.com/package/@techstack/components
