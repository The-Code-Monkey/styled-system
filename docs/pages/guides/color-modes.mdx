...
If you look at this demo [theme file][], you'll see that it includes a nested `colors.modes` object for the different color schemes.
...
This demo themes colors object looks something like the following:
...
[theme file]: https://github.com/The-Code-Monkey/styled-system/blob/main/docs/demo-theme-file.js
