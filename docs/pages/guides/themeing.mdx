...
I have created a tool to aid in creating Themes valid for styled-system. This can be found at [@techstack/theme][]
This tool has a default theme within it, but this can be partially extended using json objects.
